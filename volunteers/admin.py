...
from .models import Companies, CouponsBought, PickedUp, Volunteers, branch, exchanges, discardLost, volunteerCoupons, delivery, source
...
class CouponsBoughtAdmin(admin.ModelAdmin):
    list_display = ('amount', 'paymentMethod', 'dateOfReceive', 'payed', 'volunteer', 'company', 'range_from', 'range_to', 'flag', 'serial_letter')
    list_filter = ('volunteer', 'company')
    search_fields = ('amount', 'paymentMethod', 'dateOfReceive', 'payed', 'volunteer', 'company', 'range_from', 'range_to', 'flag', 'serial_letter')
...
admin.site.register(CouponsBought, CouponsBoughtAdmin)
